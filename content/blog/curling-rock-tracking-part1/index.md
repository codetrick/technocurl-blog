...
When I first started curling a few years ago, as a front end player, I found it difficult to keep track of the shots played and maintain a good mental picture of the end progression. The club does have monitors behind the hack to help the front end get a better view of the house, but between focusing on my then barely existent delivery consistency and keeping up with the pace of the game, I tended to lose track. I wondered at the time -- if we could overlay the trajectory of the delivered stone and the other stones that were set in motion, that would be pretty helpful.

If you've watched curling on TV, you've seen something in this direction. Commentators use [telestrators](https://en.wikipedia.org/wiki/Telestrator) to draw lines and place stones on screen before a shot to discuss strategy, but that's manual and only covers the planned shot. On the automated side, [CurlingHunter](https://pmc.ncbi.nlm.nih.gov/articles/PMC9639444/) (used at the 2022 Beijing Olympics) and [SPECTO Curling](https://www.angularvelocity.fi/specto-curling) (LIDAR-based) can actually track stones in real time as they move. I thought it would be fun to try building something like that myself.

<!--more-->

I had time during the off-season to play around with a few ideas using footage from our old broadcast system. The source is a single overhead camera mounted above sheet B at [Nutmeg Curling Club](https://nutmegcurling.com) during a Club Challenge game in 2021. The camera is a wide-angle (fisheye) type, which gives a nice field of view but introduces significant barrel distortion. Before we can do anything useful with the video, we need to undo that distortion.
